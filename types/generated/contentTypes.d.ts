...
export interface ApiCollectionCollection extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    saved_posts: Schema.Attribute.Relation<
      'oneToMany',
      'api::saved-post.saved-post'
    >;
    type: Schema.Attribute.Enumeration<['public', 'shared_posts', 'unlisted']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiPostPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    admin_remarks: Schema.Attribute.Text &
    ...
    book_reference: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    lecture_name: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
      }>;
    letter_to: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    reference_url: Schema.Attribute.Text &
      Schema.Attribute.CustomField<'plugin::url-input.url'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    source: Schema.Attribute.Enumeration<
      ['book', 'conversation', 'lecture', 'letter']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    default_collection: Schema.Attribute.Relation<
      'oneToOne',
      'api::collection.collection'
    >;
    email: Schema.Attribute.Email &
